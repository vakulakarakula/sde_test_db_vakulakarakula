...
select 4 as test_number, prom_table1.book_ref||array_agg(t.passenger_id||'|'||t.passenger_name||'|'||t.contact_data order by prom_table1.book_ref, t.passenger_id,t.passenger_name,t.contact_data) as book_ref_and_pass
    from
      (
